...
export default function Colaborador() {
  ...
  const menu = (
    <Menu>
      ...
      <Menu.Item key="0">
        <Menu.Item key="3">
          <Link to="/areasypuestos-perfil">Ver su Expediente</Link>
        </Menu.Item>
      </Menu.Item>
  ...
  return (
    <Form name="form1" layout="vertical">
      ...
      <Modal
        ...
        visible={Permisos}
        onCancel={closeModalPermisos}
        onOk={sendPermisos}
        footer={[
          <Button
            style={{ marginRight: "15px" }}
            className="secondary"
            onClick={closeModalPermisos}
          >
            Cancelar
          </Button>,
          <Button className="primary" onClick={closeModalPermisos}>
            Aplicar
          </Button>,
        ]}
      >
