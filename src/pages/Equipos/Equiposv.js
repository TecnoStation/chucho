...
export default function Equiposv() {
    ...
    const menu =(
        ...
        <Menu>
          <Menu.Item key="0">
            <Menu.Item key="01"><Link to="#">Clonar equipo</Link></Menu.Item>
          </Menu.Item>
          <Menu.Item key="1">
            <Menu.Item key="12"><Link onClick={() =>{setmodalRename(true)}} to="#">Renombrar</Link></Menu.Item>
          </Menu.Item>
          <Menu.Item key="2">
            <Menu.Item key="23"><Link to="#">Editar</Link></Menu.Item>
          </Menu.Item>
          <Menu.Divider />
          <Menu.Item key="3">
            <Menu.Item key="34"><Link to="#">Eliminar</Link></Menu.Item>
          </Menu.Item>
        </Menu>
    ...
    return (
        <>
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }} >
                ...
                <Col className="gutter-row iconBlue rigth" span={1}><span><Link to="/Equipos"><BsFillGrid3X2GapFill /></Link></span></Col>
            ...
            <Row style={{marginTop: "30px", width: "80%",paddingBottom: "20px" }} className="dividerBottomFull">
                <Col span={11}>
                    <span><b>Equipo proyecto EVOU</b></span><br/>
            ...
            <Modal title="Renombre de equipo" className="smallModal2" visible={modalRename} onCancel={() => {setmodalRename(false)} } footer={[<Button style={{marginRight: "20px", width: "100px"}} className="secondary" onClick={() => {setmodalRename(false)} } >Cancelar</Button>, <Link to="/equipos"><input type="button" className="primary" style={{width: "100px", marginRight: "40px"}} onClick={rename} value="Guardar" /> </Link>]} >
